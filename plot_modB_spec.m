%% plot_modB_spec( BDATA, NTHETA, NPHI, FILLED, NEWFIG  )
% =============================================
% 
% Plot of modB from a SPEC output
%
% INPUT
% -----
%   -data    : must be produced by calling read_spec(filename,root)
...
% ------------------------------------%
function plot_modB_spec(d, Ntheta, Nphi, filled, Newfig)

    modB = get_spec_fourier_modB(d,Ntheta,Nphi);
    Theta = modB.theta;
    Phi   = modB.phi;
    modB  = modB.modB;
